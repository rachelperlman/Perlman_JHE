...
fig1 <- ggplot(subset(df6, !is.na(season)), aes(x=season, y=sum/F.Total*100, fill=Activity3)) +
...
model <- glmer(UCP ~  Rain30 + MinT + (1 | ID), family = Gamma(link = "log"), data=df3)
...
fig_4a<-ggplot(data = fig4df1, mapping = aes(x = as.factor(x), y = y, fill=as.factor(panel))) +
  ...
  geom_bar(data = subset(fig4df1, panel %in% "Rainfall"), stat = "identity", aes(y=y*3, group = as.factor(panel), shape=as.factor(panel)), fill = "white", colour="black") +
  geom_errorbar(data = subset(fig4df1, panel %in% "Rainfall"), aes(ymin=y*3-se, ymax=y*3+se, group=panel), width=.1, position=position_dodge(0.5), colour="black") +
  geom_point(data = subset(fig4df1, panel %in% "Feeding below-ground"), aes(group = as.factor(panel), shape=as.factor(panel)), colour = "black", size=1.5) +
  geom_line(data = subset(fig4df1, panel %in% "Feeding below-ground"), aes(group=panel), position=position_dodge(0.5), colour="black", linetype=2, size=0.75) +
  geom_errorbar(data = subset(fig4df1, panel %in% "Feeding below-ground"), aes(ymin=y-se, ymax=y+se, group=panel), width=.1, position=position_dodge(0.5), colour="black") +
...
fig_4b<-ggplot(data = fig4df2, mapping = aes(x = as.factor(x), y = y, fill=as.factor(panel))) +
  geom_rect(data = df_season, aes(xmin = x-0.5, xmax = x+0.5, ymin = -Inf, ymax = Inf, fill=panel), fill = c("#abd9e9","#abd9e9","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#abd9e9","#abd9e9","#abd9e9"), alpha = 0.5) +
  scale_x_discrete(labels = c("S","O","N","D","J","F","M","A","M","J","J","A")) +
  ...
  geom_point(data = subset(fig4df2, panel %in% "Time spent feeding"), aes(y=y*100, group = as.factor(panel), shape=as.factor(panel)), colour = "black", size=1.5) +
  geom_line(data = subset(fig4df2, panel %in% "Time spent feeding"), aes(y=y*100, group=panel), position=position_dodge(0.5), colour="black", linetype=2, size=0.75) +
  geom_errorbar(data = subset(fig4df2, panel %in% "Time spent feeding"), aes(ymin=(y-se)*100, ymax=(y+se)*100, group=panel), width=.1, position=position_dodge(0.5), colour="black") +
...
fig_4c<-ggplot(data = fig4df3, mapping = aes(x = as.factor(x), y = y, fill=as.factor(panel))) +
  geom_rect(data = df_season, aes(xmin = x-0.5, xmax = x+0.5, ymin = -Inf, ymax = Inf, fill=panel), fill = c("#abd9e9","#abd9e9","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#abd9e9","#abd9e9","#abd9e9"), alpha = 0.5) +
  scale_x_discrete(labels = c("S","O","N","D","J","F","M","A","M","J","J","A")) +
  ...
  theme(axis.title = element_text(size = 10), axis.text=element_text(size=10)) + 
  theme(legend.position="none", panel.grid.minor = element_blank(), panel.grid.major = element_blank(), plot.title = element_text(hjust = 0)) +
  geom_point(data = subset(fig4df3, panel %in% "Time spent moving"), aes(y=y*100, group = as.factor(panel), shape=as.factor(panel)), colour = "black", size=1.5) +
  geom_line(data = subset(fig4df3, panel %in% "Time spent moving"), aes(y=y*100, group=panel), position=position_dodge(0.5), colour="black", linetype=2, size=0.75) +
  geom_errorbar(data = subset(fig4df3, panel %in% "Time spent moving"), aes(ymin=(y-se)*100, ymax=(y+se)*100, group=panel), width=.1, position=position_dodge(0.5), colour="black") +
...
fig_4d<-ggplot(data = fig4df4, mapping = aes(x = as.factor(x), y = y, fill=as.factor(panel))) +
  geom_rect(data = df_season, aes(xmin = x-0.5, xmax = x+0.5, ymin = -Inf, ymax = Inf, fill=panel), fill = c("#abd9e9","#abd9e9","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#fdae61","#abd9e9","#abd9e9","#abd9e9"), alpha = 0.5) +
  scale_x_discrete(labels = c("S","O","N","D","J","F","M","A","M","J","J","A")) +
  ...
  theme(legend.position="none", panel.grid.minor = element_blank(), panel.grid.major = element_blank(), plot.title = element_text(hjust = 0)) +
  geom_point(data = subset(fig4df4, panel %in% "Urinary C-peptide"), aes(y=y, group = as.factor(panel), shape=as.factor(panel)), colour = "black", size=1.5) +
  geom_line(data = subset(fig4df4, panel %in% "Urinary C-peptide"), aes(y=y, group=panel), position=position_dodge(0.5), colour="black", linetype=2, size=0.75) +
  geom_errorbar(data = subset(fig4df4, panel %in% "Urinary C-peptide"), aes(ymin=y-se, ymax=y+se, group=panel), width=.1, position=position_dodge(0.5), colour="black") +
...
save.image(file="Perlman_JHE.RData") 
